...
var UIController = (function(){
    DOMstrings = {/*--► Function Constructor ◄--*/
        inputType: '.add__type',
    ...
    return{
        ...
        addListItem: function(obj, type){
            ...
            document.querySelector(element).insertAdjacentHTML('beforeend', newHTML);/*--► https://developer.mozilla.org/en-US/docs/Web/API/Element/insertAdjacentElement ◄--*/
        },   
...
var controller = (function(budgetCtrl, UICtrl){
    ...
    var updatePercentages = function(){
        /*--▼ 6.1 - Calculate percentages ▼--*/
        budgetCtrl.calculatePercentages();

        /*--▼ 6.2 - Read percentages from the budget controller ▼--*/
        var percentages = budgetCtrl.getPercentages();

        /*--▼ 6.3 - Update the UI with the new percentages ▼--*/
