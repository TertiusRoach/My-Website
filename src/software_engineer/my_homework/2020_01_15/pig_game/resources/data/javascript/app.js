...
document.querySelector('.btn-roll').addEventListener('click', function(){
    if(gamePlaying){
        ...
        document.getElementById('dice-1').src = 'resources/footage/images/dice-' + dice1 +'.png';
        document.getElementById('dice-2').src = 'resources/footage/images/dice-' + dice2 +'.png';
...
document.querySelector('.btn-roll').addEventListener('click', function(){
    if(gamePlaying){
        ...
        diceDOM.src = 'resources/footage/images/dice-' + dice +'.png';
